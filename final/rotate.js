// I did not make this, just edited for my own purposes.
//CREDITS TO  SitePoint. Taken from https://codepen.io/SitePoint/pen/obapXL.
...
(function() {
	...
	var canvas = document.getElementById('chw0');
	...
	ctx.fillStyle = 'rgba(163, 180, 209, 0.3)';
    ...
    document.addEventListener('mouseover', changeColorBack);
	...
	function stopMove() {
		mousedown = false;
		autorotate_timeout = setTimeout(autorotate, 100);
	}
